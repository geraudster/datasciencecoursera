...
# ignore the 1st
g1 <- ggplot(top[3:nrow(top),], aes(x=EVTYPE, fill=variable, y=value)) + geom_histogram(stat="identity") + coord_flip()
g1
# 
g2 <- ggplot(top, aes(x=EVTYPE, fill=variable, y=value)) + geom_histogram(stat="identity") + coord_flip()
